	...
	<form method="post" action="options.php">
		...
		<table class="form-table" style="width:100%">
			<tr valign="top">
				...
				<td><input type="text" name="webinarjam_api_key" value="<?php echo esc_attr( get_option( 'webinarjam_api_key', '' ) ); ?>" /></td>
			</tr>
			<tr valign="top">
			...
			<tr valign="top">
				...
				<td><input type="text" name="webinarjam_paid_successfully_email_subject" value="<?php echo esc_attr( get_option( 'webinarjam_paid_successfully_email_subject', 'Successfull webinar registration' ) ); ?>" /></td>
			</tr>
			<tr valign="top">
